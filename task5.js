...
queue.push("catHorse");
console.log('Person join the queue',queue);
...
queue.shift();
console.log('Queue move one space',queue);
...
console.log('Vip member arrive',queue);
...
queue.pop();
console.log('Person leave the queue',queue);
...
queue.splice(4,1);
console.log('Emergency phone call',queue);
